...
<h4>Note that the provided dataset has been updated many times, so make sure to check the dimension of images and number of available different classes before running the COVID-CAPS model.</h4>
