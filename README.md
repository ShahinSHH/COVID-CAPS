...
<h4>Note that the provided dataset has been updated many times since the publishing of its first version, so make sure to check the dimension of images and number of available different classes before running the COVID-CAPS model.</h4>
